        ...
        <div class="container">
            <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                <div class="section-header">
                    ...
                    <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Berita Terkini</h2>
                </div>
                <a href="service.html" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                   data-wow-duration="1500ms">Lihat Selengkapnya<i class="fa-regular fa-arrow-right-long"></i></a>
            </div>
            <div class="row g-4">
        ...
        <div class="container">
            <div class="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-95">
                <div class="section-header">
                    ...
                    <h2 class="text-white wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Panduan Pedoman Teknis</h2>
                </div>
            </div>
            <div class="row g-2">
                <div class="col-lg-6 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                     data-wow-duration="1500ms">
                    <div class="offer__item">
                        ...
                        <a href="#" class="text-white mt-20 fw-bold fs-5">Panduan Pelaporan Insiden</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                     data-wow-duration="1500ms">
                    <div class="offer__item">
                        ...
                        <a href="#" class="text-white mt-20 fw-bold fs-5">
                            Panduan Penanganan Insiden Serangan SQL Injection</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                <div class="section-header">
                    ...
                    <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Peringatan Keamanan</h2>
                </div>
                <a href="service.html" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                   data-wow-duration="1500ms">Lihat Selengkapnya<i class="fa-regular fa-arrow-right-long"></i></a>
            </div>
